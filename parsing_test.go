...
func TestCompareConfigs(t *testing.T) {
	...
	cases := []tc{
		...
		},
		{
			...
			file1:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "1to1_json_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
		...
		},
		{
			...
			file1:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "1to2_json_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
			name:       "Two JSON files 1 to 2 plain format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "1to2_json_plain_expected.golden"),
			format:     "plain",
			expErr:     nil,
		},
		{
		...
		},
		{
			...
			file1:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "2to1_json_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
			name:       "Two JSON files 2 to 1 plain format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file1.json"),
		...
		{
			name:       "Two JSON files 2 to 2 stylish format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file2.json"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "2to2_json_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
		...
		{
			name:       "Two YAML files 1 to 2 stylish format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file1.yml"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file2.yml"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "1to2_yaml_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
			name:       "Two YAML files 1 to 2 plain format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file1.yml"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file2.yml"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "1to2_yaml_plain_expected.golden"),
			format:     "plain",
			expErr:     nil,
		},
		{
		...
		},
		{
			...
			file1:      filepath.Join("testdata", "fixtures", "1", "file2.yml"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file1.yml"),
			expOutPath: filepath.Join("testdata", "fixtures", "1", "2to1_yaml_stylish_expected.golden"),
			format:     "stylish",
			expErr:     nil,
		},
		{
			name:       "Two YAML files 2 to 1 plain format",
			file1:      filepath.Join("testdata", "fixtures", "1", "file2.yml"),
			file2:      filepath.Join("testdata", "fixtures", "1", "file1.yml"),
